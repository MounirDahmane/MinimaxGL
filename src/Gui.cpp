...
void Gui::render(GLFWwindow* window, int gameState, int& counter, unsigned int & win, unsigned int & lost, unsigned int & draw)
{
    ...
    ImGui::Begin("Settings");
    {
        ...
        if (this->show_demo_window) ImGui::ShowDemoWindow(&show_demo_window);
    }
    ImGui::End();
