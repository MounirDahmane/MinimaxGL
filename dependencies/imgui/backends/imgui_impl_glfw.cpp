...
#ifdef EMSCRIPTEN_USE_EMBEDDED_GLFW3
static EM_BOOL ImGui_ImplGlfw_OnCanvasSizeChange(
            ...
            for (int i = 0; i < IM_COUNTOF(bd->KeyOwnerWindows); i++)
                if (bd->KeyOwnerWindows[i] == vd->Window)
                    ImGui_ImplGlfw_KeyCallback(
                        ...
                        0,
                        GLFW_RELEASE,
                        0); // Later params are only used for main viewport, on which this function
                            // is never called.
...
static LRESULT CALLBACK ImGui_ImplGlfw_WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (msg)
    {
            ...
            // Add support for Win32 (based on imgui_impl_win32), because we rely on _TouchScreen
            // info to trickle inputs differently.
        case WM_MOUSEMOVE:
        case WM_NCMOUSEMOVE:
        case WM_LBUTTONDOWN:
        ...
        case WM_NCHITTEST:
            {
                ...
                // those viewport flags from your windowing/event code: you may manually synchronize
                // its state e.g. in your main loop after calling UpdatePlatformWindows(). Iterate
                // all viewports/platform windows and pass the flag to your windowing system.
